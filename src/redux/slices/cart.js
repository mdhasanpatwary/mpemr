...
import {getConvertDiscount, getTotalVariationsPrice} from "../../utils/CustomFunctions";
...
export const cartSlice = createSlice({
    ...
    reducers: {
        ...
        setIncrementToCartItem: (state = initialState, action) => {
            ...
            const price = action.payload.price + getTotalVariationsPrice(action.payload.food_variations)
        ...
        setRemoveItemFromCart: (state = initialState, action) => {
            state.cartList = state.cartList.filter((cartItem) =>
                cartItem.module_type === action.payload.module_type
                    ? cartItem?.id === action.payload.id ? JSON.stringify(cartItem?.selectedOption) !==
                        JSON.stringify(action.payload?.selectedOption) : cartItem
                    : cartItem
            );
        },
